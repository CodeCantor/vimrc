...
hi WildMenu        guibg=#284f28 guifg=#dcdccc gui=bold,underline
...
if exists("g:zenburn_high_Contrast")
    ...
    hi TabLineFill     guifg=grey70  guibg=grey10 gui=none
    hi TabLineSel      guifg=#ffffff guibg=#3f3f3f gui=bold
    hi TabLine         guifg=grey70  guibg=grey10 gui=none
